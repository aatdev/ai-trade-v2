---
description: Запустить premarket-слот торгового планировщика
argument-hint: [--dry-run] [--force] [--no-telegram] [--date YYYY-MM-DD]
allowed-tools: Bash(bash scripts/run_trading_schedule.sh:*)
---
Запусти **premarket**-слот торгового планировщика:

`bash scripts/run_trading_schedule.sh --slot premarket $ARGUMENTS`
