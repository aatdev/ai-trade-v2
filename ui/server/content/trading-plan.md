...
> Один и тот же демон обрабатывает **все** типы карточек: открытие (лонг/шорт), +2R (шаг 3) и
> выходы по правилам (шаг 3). +2R/close-карточки рассылает интрадей- и вечерний прогон, не премаркет.
...
🛎-сводка в дайджесте остаётся для контекста.
