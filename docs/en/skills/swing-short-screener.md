...
- `skills/swing-short-screener/references/fmp_api_endpoints.md`
- `skills/swing-short-screener/references/scoring_system.md`
- `skills/swing-short-screener/references/weakness_methodology.md`

**Scripts:**

- `skills/swing-short-screener/scripts/report_generator.py`
- `skills/swing-short-screener/scripts/scorer.py`
- `skills/swing-short-screener/scripts/screen_short.py`
- `skills/swing-short-screener/scripts/weakness_metrics.py`
