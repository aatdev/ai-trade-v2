...
| [Dividend Growth Pullback Screener]({{ '/en/skills/dividend-growth-pullback-screener/' | relative_url }}) | Use this skill to find high-quality dividend growth stocks (12%+ annual dividend growth, 1 | <span class="badge badge-free">No API</span> <span class="badge badge-optional">FINVIZ Optional</span> |
...
| [IB Portfolio Manager]({{ '/en/skills/ib-portfolio-manager/' | relative_url }}) | Comprehensive portfolio analysis using the Interactive Brokers MCP Server (interactive-brokers-mcp / bundled IB Gatew... | <span class="badge badge-free">No API</span> |
...
| [Save Note]({{ '/en/skills/save-note/' | relative_url }}) | Сохранить результат, заметку, отчёт или артефакт в личную базу знаний MyNotes ($MYNOTES_DIR из окружения или | <span class="badge badge-free">No API</span> |
...
| [Send Telegram]({{ '/en/skills/send-telegram/' | relative_url }}) | Send textual messages or files (documents, images, logs, reports) to a Telegram chat using a Telegram Bot | <span class="badge badge-free">No API</span> |
...
| [Signals Alerts]({{ '/en/skills/signals-alerts/' | relative_url }}) | Создать, удалить или синхронизировать алерты в TradingView Desktop на основе журнала `trading-data/analysis/signals | <span class="badge badge-free">No API</span> |
...
| [Swing Short Screener]({{ '/en/skills/swing-short-screener/' | relative_url }}) | Screen S&P 500 (or a custom universe) for Stage 4 downtrend weakness — the short-side mirror of vcp-screener | <span class="badge badge-free">No API</span> |
...
| [Ticker Analysis]({{ '/en/skills/ticker-analysis/' | relative_url }}) | Полный комплексный анализ одной акции по тикеру — новостной фон, фундаментал и технический анализ через TradingView M... | <span class="badge badge-free">No API</span> |
...
| [Tradingview Screener]({{ '/en/skills/tradingview-screener/' | relative_url }}) | Screen stocks via the TradingView Stock Screener (All Stocks tab) scanner API from natural language requests | <span class="badge badge-free">No API</span> |
...
| [Value Dividend Screener]({{ '/en/skills/value-dividend-screener/' | relative_url }}) | Screen US stocks for high-quality dividend opportunities combining value characteristics (P/E ratio under 20, P/B rat... | <span class="badge badge-free">No API</span> <span class="badge badge-optional">FINVIZ Optional</span> |
