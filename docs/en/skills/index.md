...
| [Signals Alerts]({{ '/en/skills/signals-alerts/' | relative_url }}) | Создать, удалить или синхронизировать алерты в TradingView Desktop на основе журнала `results/analysis/signals | <span class="badge badge-free">No API</span> |
...
| [Swing Short Screener]({{ '/en/skills/swing-short-screener/' | relative_url }}) | Screen S&P 500 (or a custom universe) for Stage 4 downtrend weakness — the short-side mirror of vcp-screener | <span class="badge badge-api">FMP Required</span> |
