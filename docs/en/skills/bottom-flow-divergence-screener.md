---
layout: default
title: "Bottom Flow Divergence Screener"
grand_parent: English
parent: Skill Guides
nav_order: 11
lang_peer: /ja/skills/bottom-flow-divergence-screener/
permalink: /en/skills/bottom-flow-divergence-screener/
generated: true
---
...
- `skills/bottom-flow-divergence-screener/references/divergence_methodology.md`

**Scripts:**

- `skills/bottom-flow-divergence-screener/scripts/report_generator.py`
- `skills/bottom-flow-divergence-screener/scripts/scorer.py`
