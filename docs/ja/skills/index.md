...
| [Dividend Growth Pullback Screener]({{ '/ja/skills/dividend-growth-pullback-screener/' | relative_url }}) | Use this skill to find high-quality dividend growth stocks (12%+ annual dividend growth, 1 | <span class="badge badge-free">API不要</span> <span class="badge badge-optional">FINVIZ任意</span> |
...
| [IB Portfolio Manager]({{ '/ja/skills/ib-portfolio-manager/' | relative_url }}) | Comprehensive portfolio analysis using the Interactive Brokers MCP Server (interactive-brokers-mcp / bundled IB Gatew... | <span class="badge badge-free">API不要</span> |
| [Ibd Distribution Day Monitor]({{ '/ja/skills/ibd-distribution-day-monitor/' | relative_url }}) | Detect IBD-style Distribution Days for QQQ/SPY (close down at least 0 | <span class="badge badge-free">API不要</span> |
...
| [Save Note]({{ '/ja/skills/save-note/' | relative_url }}) | Сохранить результат, заметку, отчёт или артефакт в личную базу знаний MyNotes ($MYNOTES_DIR из окружения или | <span class="badge badge-free">API不要</span> |
...
| [Send Telegram]({{ '/ja/skills/send-telegram/' | relative_url }}) | Send textual messages or files (documents, images, logs, reports) to a Telegram chat using a Telegram Bot | <span class="badge badge-free">API不要</span> |
...
| [Signals Alerts]({{ '/ja/skills/signals-alerts/' | relative_url }}) | Создать, удалить или синхронизировать алерты в TradingView Desktop на основе журнала `trading-data/analysis/signals | <span class="badge badge-free">API不要</span> |
...
| [Swing Short Screener]({{ '/ja/skills/swing-short-screener/' | relative_url }}) | Screen S&P 500 (or a custom universe) for Stage 4 downtrend weakness — the short-side mirror of vcp-screener | <span class="badge badge-free">API不要</span> |
...
| [Ticker Analysis]({{ '/ja/skills/ticker-analysis/' | relative_url }}) | Полный комплексный анализ одной акции по тикеру — новостной фон, фундаментал и технический анализ через TradingView M... | <span class="badge badge-free">API不要</span> |
...
| [Trader Memory Core]({{ '/ja/skills/trader-memory-core/' | relative_url }}) | Track investment theses across their lifecycle — from screening idea to closed position with postmortem | <span class="badge badge-free">API不要</span> |
...
| [Tradingview Screener]({{ '/ja/skills/tradingview-screener/' | relative_url }}) | Screen stocks via the TradingView Stock Screener (All Stocks tab) scanner API from natural language requests | <span class="badge badge-free">API不要</span> |
...
| [Value Dividend Screener]({{ '/ja/skills/value-dividend-screener/' | relative_url }}) | Screen US stocks for high-quality dividend opportunities combining value characteristics (P/E ratio under 20, P/B rat... | <span class="badge badge-free">API不要</span> <span class="badge badge-optional">FINVIZ任意</span> |
